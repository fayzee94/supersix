...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2014 at 06:51 AM
...
-- Database: `supersix`
--
CREATE DATABASE IF NOT EXISTS `supersix` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `supersix`;
...
INSERT INTO `match` (`id`, `h_id`, `a_id`, `h_s`, `a_s`, `stage`) VALUES
(45, 6, 1, 0, 0, 'group'),
(46, 40, 59, 0, 0, 'FinalBowl');
...
INSERT INTO `sekolah2` (`id`, `name_b`, `code`, `short_b`, `group`, `division`) VALUES
(1, 'Sekolah Tuanku Abdul Rahman', 'A1', 'STAR', 'A', '1'),
(2, 'SM Sains Tuanku Syed Putra', 'A2', 'SMSTSP', 'A', '1'),
(3, 'SM Sains Tengku Abdullah', 'A3', 'SEMESTA', 'A', '1'),
(4, 'SBP Integrasi Rawang, Selangor', 'A4', 'SBPI Gombak', 'A', '1'),
